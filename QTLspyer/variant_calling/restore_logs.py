...
def main():
    ...
    with open('log/sample_processing.log', 'w') as f:
        f.write(
            ...
            f"Before you start please make sure that all the inputs required\n"
            f"are provided and are appropriate for your target organism.\n"
            ...
            f"Re-running from the last successful completed step is recommended\n\n"
